...
<style>
    ...
    h1 {color: #ffd700 !important; font-size: 2.2em;}
    .stTabs [data-baseweb="tab"] {color: #ffffff; font-weight: 600;}
    .stTabs [data-baseweb="tab-highlight"] {background-color: #ffd700 !important;}
    .real-time {color: #00ff88; font-weight: bold;}
</style>
""", unsafe_allow_html=True)

st.title("🤖 Kwork Монитор ИИ-заказов")
st.caption("⚡ Реальное время • Обновление каждые 2 секунды • Премиум дашборд для команды")
...
st.success(f"⚡ Обновлено автоматически: {datetime.now().strftime('%H:%M:%S')}")
